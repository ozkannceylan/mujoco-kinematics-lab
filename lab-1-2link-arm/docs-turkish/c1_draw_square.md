...
|-------|---------------------|------|
| A2 (`src/a2_forward_kinematics.py`) | FK referans geometrisi | Yol mantigi ve workspace sezgisi |
| A3 (`src/a3_jacobian.py`) | `analytic_jacobian` | J⁻¹ ile hız eşlemesi |
...
| B1 (`src/b1_trajectory_generation.py`) | `quintic_profile` | Pürüzsüz Cartesian yol |
