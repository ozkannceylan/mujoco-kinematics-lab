...
- **Dis sinir:** `r = L₁ + L₂_eff = 0.615 m`
- **Ic sinir:** `r = |L₁ - L₂_eff| = 0.015 m`
- Site offset hesaba katilmazsa workspace tam disk gibi gorunur; 1.5 cm tool offset eklendiginde cok ince bir halka yapisi ortaya cikar.
