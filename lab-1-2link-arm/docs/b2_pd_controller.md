...
The four CSV logs are the core outputs. The PNG is optional and depends on plotting support.
If `matplotlib` is unavailable, the plot file will simply not exist in the current snapshot.
