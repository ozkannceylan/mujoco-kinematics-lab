...
- **Outer boundary:** `r = L₁ + L₂_eff = 0.615 m`
- **Inner boundary:** `r = |L₁ - L₂_eff| = 0.015 m`
- Without the site offset the arm would look like a full-disk workspace; with the extra 1.5 cm tool offset it becomes a very thin annulus.
