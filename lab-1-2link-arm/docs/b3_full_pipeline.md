...
The CSV logs are the primary outputs. The plot and GIF are optional convenience artifacts.
If plotting or GIF-writing support is missing, those visual artifacts may be absent even though the script contains the export path.
